...
class TarefaController {
    ...
    def save(Tarefa tarefaInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'tarefaInstance.label', default: 'Tarefa'), tarefaInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'tarefaInstance.label', default: 'Tarefa'), params.id])
                redirect action: "index", method: "GET"
            }
